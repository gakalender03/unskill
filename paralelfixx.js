...
class Utils {
  ...
  // Generate ABI-encoded data with signer's address and unique identifier
  static generateABIEncodedData(signerAddress) {
    // Generate a unique identifier (e.g., a random 32-byte hex string)
    const uniqueIdentifier = ethers.hexlify(ethers.randomBytes(32));

    // Original hex string with placeholders for the unique identifier
    const originalHex = "";

    // Insert the unique identifier into the hex string
    const updatedHex = originalHex.slice(0, 66) + uniqueIdentifier.slice(2) + originalHex.slice(66);
...
class BridgeManager {
  ...
  async bridgeTokens(wallet, nonceManager, amount, txCount) {
    try {
      ...
      const instructionData = Utils.generateABIEncodedData(signerAddress);
      const instruction = [0, 2, instructionData];
