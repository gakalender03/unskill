...
class BridgeManager {
  ...
  async bridgeTokens(wallet, nonceManager, amount, txCount) {
    try {
      ...
      // Dynamically replace the embedded address in the instruction
      const prefixedAddress = '14' + wallet.address.toLowerCase().replace(/^0x/, '');
      const oldPrefixedAddress = '14a8068e71a3f46c888c39ea5deba318c16393573b';
      
      const instructionHexOriginal = '';

      // Replace the old address with the new one
      const updatedInstructionHex = instructionHexOriginal.split(oldPrefixedAddress).join(prefixedAddress);

      // Final instruction with updated hex
      const instruction = [
        0,
        2,
