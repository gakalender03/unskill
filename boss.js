...
function generateIBCParams(senderAddress, recipientAddress) {
  ...
  // Define the payload with placeholders for sender and recipient
  const payload = ``;

  // Replace both occurrences of the sender address placeholder with actual sender address
  const updatedPayload = payload.replace(
    /14a8068e71a3f46c888c39ea5deba318c16393573b/g,  // Replace all occurrences of the sender address
  ...
  return {
    channelId: 2,
    timeoutHeight: 0,
    timeoutTimestamp: timeoutTimestamp.toString(), // String to avoid JS number precision issues
    salt,
    instruction: {
      version: 0,
      action: 2,
      payload: updatedPayload,  // Updated payload with the sender's address
    },
  };
}
